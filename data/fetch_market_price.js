...
const instruments = [
  ...
  'usdcad', 'usdchf', 'usdcnh', 'usddkk',
  'usdhkd', 'usdhuf', 'usdjpy', 'usdmxn', 
  'usdnok', 'usdsek', 'usdsgd', 'usdzar',
  'lightcmdusd', 'xagusd', 'xauusd', 
  'xptcmdusd', 'ausidxaud', 'eusidxeur', 'fraidxeur',
  'deuidxeur', 'hkgidxhkd', 'jpnidxjpy', 'usatechidxusd', 
  'nldidxeur', 'usa500idxusd', 'cheidxchf', 'gbridxgbp',
  'ussc2000idxusd', 'usa30idxusd'
]; // Add more as needed
